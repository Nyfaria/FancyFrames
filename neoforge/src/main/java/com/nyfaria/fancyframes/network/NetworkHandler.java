package com.nyfaria.fancyframes.network;
...
public class NetworkHandler {
    ...
    public static void register() {
        ...
        SimpleEntityCapabilityStatusPacket.registerRetriever(FrameHolderAttacher.RESOURCE_LOCATION, FrameHolderAttacher::getHolderUnwrap);
