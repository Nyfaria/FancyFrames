...
public class WoodenFrameThin extends FrameModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition top_left_connector = group.addOrReplaceChild("top_left_connector", CubeListBuilder.create().texOffs(8, 6).addBox(-1.0F, -16.0F, 8.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F))
                .texOffs(8, 10).addBox(14.0F, -16.0F, 8.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F))
                .texOffs(8, 8).addBox(13.0F, -1.0F, 8.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F))
                .texOffs(8, 4).addBox(-1.0F, -1.0F, 8.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offset(-7.0F, 8.0F, -9.0F));
