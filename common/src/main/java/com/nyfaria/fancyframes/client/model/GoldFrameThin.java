...
public class GoldFrameThin extends FrameModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_frame = group.addOrReplaceChild("left_frame", CubeListBuilder.create().texOffs(4, 4).addBox(-1.0F, -15.0F, 9.0F, 1.0F, 14.0F, 1.0F, new CubeDeformation(-0.05F)), PartPose.offset(-7.0F, 8.0F, -9.5F));
