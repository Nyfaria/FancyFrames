...
public class CopperFrame extends FrameModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_frame = group.addOrReplaceChild("left_frame", CubeListBuilder.create().texOffs(0, 6).addBox(-1.0F, -15.0F, 9.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(20, 17).addBox(-1.0F, -15.0F, 9.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(-7.0F, 8.0F, -9.5F));
        ...
        PartDefinition right_frame = group.addOrReplaceChild("right_frame", CubeListBuilder.create().texOffs(6, 6).addBox(-3.0F, -15.0F, 9.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(26, 17).addBox(-3.0F, -15.0F, 9.0F, 2.0F, 14.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(9.0F, 8.0F, -9.5F));
        ...
        PartDefinition cube_r1 = top_left_connector.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(12, 6).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(1.0F, -14.0F, 9.5F, 0.0F, 0.0F, -0.3927F));
        ...
        PartDefinition cube_r2 = bottom_left_connector.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 18).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(1.0F, -20.0F, 9.5F, -0.0009F, -0.0615F, -1.1733F));
        ...
        PartDefinition cube_r3 = bottom_right_connector.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(12, 14).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-4.0F, -20.0F, 9.5F, 0.0F, 0.0F, -0.3927F));
        ...
        PartDefinition cube_r4 = top_right_connector.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(12, 10).addBox(-1.0F, -2.0F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-4.0F, -14.0F, 9.5F, 0.0F, 0.0F, 0.3927F));
